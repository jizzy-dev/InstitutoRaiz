function adicionarValidacao() {
    ...
    const textBoxesReadOnly = document.querySelectorAll('.textbox:read-only');
    ...
    textBoxes.forEach(textBox => {
        ...
        textBox.addEventListener('click', () => {
            if (textBox.readOnly) {
                errorSpan.innerHTML = 'Não pode ser alterado';
                errorSpan.style.color = '#6a6a6a';
                errorSpan.classList.remove('display-none'); // Remover a classe antes de exibir a mensagem
                setTimeout(() => {
